...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" 
	...
	<xsl:template match="table" mode="controller">
        ...
        <xsl:variable name="class_file_name" select="concat($path_prefix,'/',$mapping_path_suffix,'/',$class_name,'Controller.php')"/>
...
namespace App\Controller\<xsl:value-of select="$mapping_path_suffix"/>;
